...
void I2C_MASTER_init(I2C_enu_index_t Copy_enu_I2C_index,u8 Address_Size,u16 SlaveAddress,u8 WriteOrRead,u8 bytes)
{
    ...
    {
        I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 &= ~(1<<11);
        I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 |= (SlaveAddress);

    }
    else if (Address_Size == TEN_BIT_ADDRESS)
    {
        I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 |= (1<<11);
        I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 &= 0xFFFFFC00;
        SlaveAddress &= (0x000003FF); 
        I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 |= (SlaveAddress<<1);
    }
    if (WriteOrRead == WRITE_REQUEST)
    {
        I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 &=~(1<<10);
    }
    ...
    I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 &= (0xFF00FFFF);
    I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_CR2 |= (bytes<<16);
}
...
{
	  u32 loc_u32_I2Cx[I2C_MAX_INDEX] = {I2C_1_BASE,I2C_2_BASE,I2C_3_BASE};
    I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_TXDR = data;
    while (!(I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_ISR & 0x00000001));
}

void I2C1_Read_byte(I2C_enu_index_t Copy_enu_I2C_index,u8 *data)
{
	 u32 loc_u32_I2Cx[I2C_MAX_INDEX] = {I2C_1_BASE,I2C_2_BASE,I2C_3_BASE};
	 while (!(I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_ISR & 0x00000004));
    *data = I2Cx(loc_u32_I2Cx[Copy_enu_I2C_index])->I2C_RXDR;
}
