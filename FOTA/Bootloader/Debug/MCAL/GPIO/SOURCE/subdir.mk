...
MCAL/GPIO/SOURCE/%.o MCAL/GPIO/SOURCE/%.su MCAL/GPIO/SOURCE/%.cyclo: ../MCAL/GPIO/SOURCE/%.c MCAL/GPIO/SOURCE/subdir.mk
...
clean: clean-MCAL-2f-GPIO-2f-SOURCE

clean-MCAL-2f-GPIO-2f-SOURCE:
	-$(RM) ./MCAL/GPIO/SOURCE/gpio.cyclo ./MCAL/GPIO/SOURCE/gpio.d ./MCAL/GPIO/SOURCE/gpio.o ./MCAL/GPIO/SOURCE/gpio.su

.PHONY: clean-MCAL-2f-GPIO-2f-SOURCE
